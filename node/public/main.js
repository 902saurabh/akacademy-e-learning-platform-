...
class CourseListComponent {
    ...
    addToCart(course_id) {
        ...
        if (localStorage.getItem("user_email") === null) {
            ...
            const uid = (_a = localStorage.getItem("user_id")) === null || _a === void 0 ? void 0 : _a.slice(1, -1);
            this.http.post('api/v1/edit_user/addToCart/', {
                id: uid,
                courseId: course_id
            }).subscribe(res => {
                alert(res.msg);
...
CourseListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CourseListComponent, selectors: [["app-course-list"]], decls: 8, vars: 1, consts: [[1, "collection"], [1, "container", "py-5"], [1, "float-right", 3, "routerLink", "click"], [1, "row", "py-5"], ["class", "col-lg-3", 4, "ngFor", "ngForOf"], [1, "col-lg-3"], [1, "card", "px-2", "py-2"], ["alt", "courses", 1, "img-fluid", "mb-3", 3, "src"], ["id", "cartButton", 3, "click"], [1, "float-right"], [3, "ngStyle"], [3, "ngClass"]], template: function CourseListComponent_Template(rf, ctx) { if (rf & 1) {
...
class PaymentComponent {
    ...
    onSubmit(form) {
        ...
        if (form.valid) {
            ...
            this.http.post('api/payment/order/', params)
                .subscribe((res) => {
                console.log(res);
...
class MycartComponent {
    ...
    ngOnInit() {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (localStorage.getItem("user_email") === null) {
                ...
                const uid = (_a = localStorage.getItem("user_id")) === null || _a === void 0 ? void 0 : _a.slice(1, -1);
                this.courses = yield this.courseService.getMyCartCourses(uid || "");
            }
        });
    }
    viewDetailClick() {
    ...
    onClickRemove(course_id) {
        var _a;
        const uid = (_a = localStorage.getItem("user_id")) === null || _a === void 0 ? void 0 : _a.slice(1, -1);
        this.http.post('api/v1/edit_user/removeFromCart/', {
            id: uid,
            courseId: course_id
        }).subscribe(res => {
            alert(res.msg);
            ...
            if (res.status === "success") {
                ...
                var options = {
                    ...
                    "handler": (res) => {
                        ...
                        this.order_sign = res.razorpay_signature;
                        const uid = (_a = localStorage.getItem("user_id")) === null || _a === void 0 ? void 0 : _a.slice(1, -1);
                        this.http.post('api/v1/edit_user/addToMycourse/', {
                            id: uid,
                            courseId: course_id
                        }).subscribe(res => {
                            alert(res.msg);
...
class ArticleComponent {
    ...
    getArticle() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let art = yield this.http.post("getOneArticle", { uri: this.uri }).toPromise().then(data => {
    ...
    getLatestArticles() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let art = yield this.http.get("getArticles").toPromise().then(data => {
                this.articles = data;
            });
        });
    }
...
NavbarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NavbarComponent, selectors: [["app-navbar"]], decls: 25, vars: 13, consts: [[1, "navbar", "navbar-expand-lg", "navbar-light", "bg-light"], [1, "container-fluid"], ["href", "#", "pr-5", "", 1, "navbar-brand", 3, "routerLink"], ["type", "button", "data-bs-toggle", "collapse", "data-bs-target", "#navbarSupportedContent", "aria-controls", "navbarSupportedContent", "aria-expanded", "false", "aria-label", "Toggle navigation", 1, "navbar-toggler"], [1, "navbar-toggler-icon"], ["id", "navbarSupportedContent", 1, "collapse", "navbar-collapse"], [1, "navbar-nav", "me-auto", "mb-2", "mb-lg-0"], [1, "nav-item"], ["aria-current", "page", "pr-5", "", 1, "nav-link", "active", 3, "routerLink"], ["pr-5", "", 1, "nav-link", 3, "routerLink"], ["class", "nav-item float-right", 4, "ngIf", "ngIfElse"], ["class", "nav-item float-right", 4, "ngIf"], ["other_content", ""], [1, ""], [1, "nav-item", "float-right"], ["tabindex", "-1", "aria-disabled", "true", "pr-5", "", 1, "nav-link"], ["tabindex", "-1", "aria-disabled", "true", "pr-5", "", 1, "nav-link", 3, "routerLink", "click"], ["href", "#", "tabindex", "-1", "aria-disabled", "true", "pr-5", "", 1, "nav-link", 3, "routerLink"]], template: function NavbarComponent_Template(rf, ctx) { if (rf & 1) {
...
function IndexComponent_div_101_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](9, "$24.99");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipeBind1"](5, 3, ctx_r0.courses[index_r2].name));
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](7);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"]("$", ctx_r0.courses[index_r2].cost, "");
} }
const _c0 = function (a1) { return ["/article", a1]; };
function IndexComponent_div_168_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](3, "p", 61);
...
IndexComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: IndexComponent, selectors: [["app-index"]], decls: 170, vars: 5, consts: [["lang", "en"], ["charset", "utf-8"], ["name", "viewport", "content", "width=device-width, initial-scale=1"], ["href", "https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css", "rel", "stylesheet", "integrity", "sha384-giJF6kkoqNQ00vy+HMDP7azOuL0xtbfIcaT9wjKHr8RbDVddVHyTfAAsrekwKmP1", "crossorigin", "anonymous"], ["href", "http://code.jquery.com/ui/1.10.2/themes/smoothness/jquery-ui.css", "rel", "Stylesheet"], ["rel", "stylesheet", "href", "https://pro.fontawesome.com/releases/v5.10.0/css/all.css", "integrity", "sha384-AYmEC3Yw5cVb3ZcuHtOA93w35dYTsvhLPVnYs9eStHfGJvOvKxVfELGroGkvsg+p", "crossorigin", "anonymous"], ["id", "carouselExampleCaptions", "data-bs-ride", "carousel", 1, "carousel", "slide"], [1, "carousel-indicators"], ["data-bs-target", "#carouselExampleCaptions", "data-bs-slide-to", "0", 1, "active"], ["data-bs-target", "#carouselExampleCaptions", "data-bs-slide-to", "1"], ["data-bs-target", "#carouselExampleCaptions", "data-bs-slide-to", "2"], [1, "carousel-inner"], [1, "carousel-item", "active"], ["src", "assets/img/slider1.jpg", "alt", "...", 1, "d-block", "w-100"], [1, "carousel-caption", "d-none", "d-md-block"], [1, "container"], [1, "row", "justify-content-start", "text-left"], [1, "col-lg-8", "mx-auto"], [1, "btn0", "mt-3", "ml-2"], [1, "carousel-item"], ["src", "assets/img/slider2.jpg", "alt", "...", 1, "d-block", "w-100"], ["src", "assets/img/slider3.jpg", "alt", "...", 1, "d-block", "w-100"], ["href", "#carouselExampleCaptions", "role", "button", "data-bs-slide", "prev", 1, "carousel-control-prev"], ["aria-hidden", "true", 1, "carousel-control-prev-icon"], [1, "visually-hidden"], ["role", "button", "data-bs-slide", "next", 1, "carousel-control-next", 3, "routerLink"], ["aria-hidden", "true", 1, "carousel-control-next-icon"], [1, "sub"], [1, "container", "py-5", "text-white"], [1, "row"], [1, "col-lg-3", "col-md-6", "col-sm-6", "col-12"], [1, "col-lg-2"], [1, "fas", "fa-sync"], [1, "col-lg-10"], [1, "fas", "fa-gift"], [1, "fas", "fa-user-shield"], ["type", "text", "placeholder", "Your Email", "name", ""], [1, "btn1"], [1, "collection"], [1, "container", "py-5"], [1, "text-center"], [1, "row", "py-5"], ["class", "col-lg-3", 4, "ngFor", "ngForOf"], [1, "parallex", "py-5"], [1, "container", "py-5", "text-white", "text-center"], [1, "row", "py-3"], [1, "col-lg-9", "mx-auto"], [1, "py-3"], [1, "btn2", "mr-1"], [1, "btn3"], [1, "col-lg-3"], [1, "card"], ["src", "assets/img/img8.jpg", 1, "img-fluid", "mb-3"], ["src", "assets/img/img9.jpg", 1, "img-fluid", "mb-3"], ["src", "img/img4.jpg", 1, "img-fluid", "mb-3"], ["src", "assets/img/img2.jpg", 1, "img-fluid", "mb-3"], [1, "article"], ["class", "col-lg-4", 4, "ngFor", "ngForOf"], [1, "img-fluid", "mb-3", 3, "src"], [1, "col-lg-4"], [1, "img-fluid", 2, "width", "250px", "height", "200px", 3, "src"], [1, "pt-3"], [2, "text-decoration", "none", 3, "routerLink"]], template: function IndexComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](101, IndexComponent_div_101_Template, 12, 5, "div", 42);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](123, "DS & Algo in C++");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](126, "del");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](127, "$24.99");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](128, "span");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](129, "$12.99");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](130, "div", 50);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](131, "div", 51);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](132, "img", 53);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](133, "h5");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](134, "Complete web development Bootcamp");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](135, "p");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](136, "small");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](137, "del");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](138, "$24.99");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](139, "span");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](140, "$12.99");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](143, "img", 54);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](144, "h5");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](145, "Applied AI Course");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](146, "p");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](147, "small");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](148, "del");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](149, "$24.99");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](150, "span");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](151, "$12.99");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](152, "div", 50);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](153, "div", 51);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](154, "img", 55);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](155, "h5");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](156, "Java & Spring framnework");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](159, "del");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](160, "$24.99");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](161, "span");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](162, "$12.99");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](163, "section", 56);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](164, "div", 39);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](165, "h1", 40);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](166, "Latest Articles");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](167, "div", 41);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](168, IndexComponent_div_168_Template, 10, 7, "div", 57);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](169, "app-footer");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    } if (rf & 2) {
...
class CoursesService {
    ...
    getAllCourses() {
        let courses = [];
        this.http.get("api/v1/courses/").subscribe(data => {
    ...
    getMyCartCourses(user_id) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let courses = [];
            const temp = yield this.http.post("api/v1/edit_user/getCartCourses", { id: user_id })
                .toPromise().then(res => {
                courses = res.data;
    ...
    getCoursesByIds(ids) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let courses = [];
            const temp = this.http.post("api/v1/edit_user/getCoursesByIds", { ids }).subscribe(res => {
                courses = res.data;
                return courses;
            });
        });
    ...
    */
    getMyCourses(user_id) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let courses = [];
            const temp = yield this.http.post("api/v1/edit_user/getMyCourses", { id: user_id })
                .toPromise().then(res => {
                courses = res.data;
                console.log(res.data);
            });
...
/* harmony import */ var _component_login_login_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./component/login/login.component */ "g8H4");
/* harmony import */ var _component_register_register_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./component/register/register.component */ "nEsl");
/* harmony import */ var _component_course_list_course_list_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./component/course-list/course-list.component */ "8pcd");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_17__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _component_login_login_component__WEBPACK_IMPORTED_MODULE_18__["LoginComponent"], _component_register_register_component__WEBPACK_IMPORTED_MODULE_19__["RegisterComponent"], _component_index_index_component__WEBPACK_IMPORTED_MODULE_6__["IndexComponent"], _component_course_list_course_list_component__WEBPACK_IMPORTED_MODULE_20__["CourseListComponent"], _component_mycart_mycart_component__WEBPACK_IMPORTED_MODULE_9__["MycartComponent"], _component_article_article_component__WEBPACK_IMPORTED_MODULE_14__["ArticleComponent"], _component_index_index_component__WEBPACK_IMPORTED_MODULE_6__["IndexComponent"],
    ...
    ngOnInit() {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (localStorage.getItem("user_email") === null) {
                ...
                const uid = (_a = localStorage.getItem("user_id")) === null || _a === void 0 ? void 0 : _a.slice(1, -1);
                this.courses = yield this.courseService.getMyCourses(uid || "");
            }
        });
    }
    viewDetailClick() {
...
class LoginComponent {
    ...
    onSubmit(form) {
        ...
        //this.router.navigate(['/login']);
        if (form.valid) {
            this.http.post('api/v1/auth/login/', form.value)
                .subscribe((res) => {
                console.log(res);
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 35, vars: 6, consts: [[1, "container"], [1, "d-flex", "justify-content-center", "h-100"], [1, "card"], [1, "card-header"], [1, "card-body"], [3, "ngSubmit"], ["newUserForm", "ngForm"], [1, "input-group", "form-group"], [1, "input-group-prepend"], [1, "input-group-text"], [1, "fas", "fa-user"], ["required", "", "type", "email", "placeholder", "e-mail", "name", "email", 1, "form-control", 3, "ngModel", "ngModelChange"], ["typedEmail", "ngModel"], ["style", "color: red;", 4, "ngIf"], [1, "fas", "fa-key"], ["required", "", "type", "password", "placeholder", "password", "name", "password", 1, "form-control", 3, "ngModel", "ngModelChange"], ["typedPassword", "ngModel"], [1, "row", "align-items-center", "remember"], ["type", "checkbox"], [1, "form-group"], ["type", "submit", "value", "Login", 1, "btn", "float-right", "login_btn"], [1, "card-footer"], [1, "d-flex", "justify-content-center", "links"], ["href", "#", 3, "routerLink"], [2, "color", "red"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        const _r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
...
class RegisterComponent {
    ...
    onSubmit(form) {
        ...
        //this.router.navigate(['/login']);
        if (form.valid) {
            this.http.post('api/v1/auth/register/', form.value)
                .subscribe((res) => {
                console.log(res);
                this.router.navigate(['/login']);
...
RegisterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RegisterComponent, selectors: [["app-register"]], decls: 42, vars: 8, consts: [[1, "container"], [1, "d-flex", "justify-content-center", "h-100"], [1, "card"], [1, "card-header"], [1, "card-body"], [3, "ngSubmit"], ["newUserForm", "ngForm"], [1, "input-group", "form-group"], [1, "input-group-prepend"], [1, "input-group-text"], [1, "fas", "fa-user"], ["required", "", "maxlength", "25", "type", "text", "placeholder", "username", "name", "name", 1, "form-control", 3, "ngModel", "ngModelChange"], ["typedName", "ngModel"], ["style", "color: red;", 4, "ngIf"], ["required", "", "type", "email", "placeholder", "e-mail", "name", "email", 1, "form-control", 3, "ngModel", "ngModelChange"], ["typedEmail", "ngModel"], [1, "fas", "fa-key"], ["required", "", "type", "password", "placeholder", "password", "name", "password", 1, "form-control", 3, "ngModel", "ngModelChange"], ["typedPassword", "ngModel"], [1, "row", "align-items-center", "remember"], ["type", "checkbox"], [1, "form-group"], ["type", "submit", "value", "Register", 1, "btn", "float-right", "login_btn"], [1, "card-footer"], [1, "d-flex", "justify-content-center", "links"], ["href", "#", 3, "routerLink"], [2, "color", "red"]], template: function RegisterComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](8, "div", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](9, "form", 5, 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function RegisterComponent_Template_form_ngSubmit_9_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); const _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](10); return ctx.onSubmit(_r0); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](11, "div", 7);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](12, "div", 8);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](13, "span", 9);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](14, "i", 10);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RegisterComponent_Template_input_ngModelChange_29_listener($event) { return ctx.password = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
